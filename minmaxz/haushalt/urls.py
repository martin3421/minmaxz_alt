...
from .api import BuchungViewSet, KontoViewSet, BuchungenListe, DeviseWertpapierViewSet
from . import views
...
router = routers.DefaultRouter()
router.register('api/devisenwertpapiere', DeviseWertpapierViewSet, 'devisenwertpapiere')
